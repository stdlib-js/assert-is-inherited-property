...
```javascript
import isInheritedProperty from 'https://cdn.jsdelivr.net/gh/stdlib-js/assert-is-inherited-property@v0.2.3-deno/mod.js';
```
...
[test-image]: https://github.com/stdlib-js/assert-is-inherited-property/actions/workflows/test.yml/badge.svg?branch=v0.2.3
[test-url]: https://github.com/stdlib-js/assert-is-inherited-property/actions/workflows/test.yml?query=branch:v0.2.3
