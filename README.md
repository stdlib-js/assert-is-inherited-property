...
```javascript
isInheritedProperty = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/assert-is-inherited-property@umd/bundle.js' )
```

To include the bundle in a webpage,

```html
<script type="text/javascript" src="https://cdn.jsdelivr.net/gh/stdlib-js/assert-is-inherited-property@umd/bundle.js"></script>
```
