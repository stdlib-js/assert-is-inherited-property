...
```javascript
import isInheritedProperty from 'https://cdn.jsdelivr.net/gh/stdlib-js/assert-is-inherited-property@v0.1.0-deno/mod.js';
```
...
[test-image]: https://github.com/stdlib-js/assert-is-inherited-property/actions/workflows/test.yml/badge.svg?branch=v0.1.0
[test-url]: https://github.com/stdlib-js/assert-is-inherited-property/actions/workflows/test.yml?query=branch:v0.1.0
