...
```javascript
isInheritedProperty = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/assert-is-inherited-property@v0.2.1-umd/browser.js' )
```
...
```html
<script type="text/javascript" src="https://cdn.jsdelivr.net/gh/stdlib-js/assert-is-inherited-property@v0.2.1-umd/browser.js"></script>
```
